...
var budgetController = (function() {
	...
	var calculateTotal = function(type){
		var sum = 0;//0
		data.allItems[type].forEach(function(cur) {//[300, 400, 500]
			sum += cur.value;//0 = 0+300;, 300 = 300 + 400;, 700 = 700 + 500 loops ends
		})
	...
	return{
		...
		calculateBudget: function() {
			...
			//calculate the percentage of income test we spent
...
var UIController = (function(){
	...
	var formatNumber =  function(num, type){
		/*
			+ or - before Number
			exacrtly 2 decimal points
			commaa  separating the thousands
			example
			2345.9876 -> + 2,345.98
			2000 -> +2,000.00
		*/
